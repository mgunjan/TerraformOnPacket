...
master_hostname="K8s-Networking-Master"
worker_hostname="k8s-Networking-Worker"
...
# master_server_type="c1.large.arm" # large x86 server with 10G Mellanox card
worker_server_type="m1.xlarge" # large arm server with 10G Mellanox cards
